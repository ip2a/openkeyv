...
class LoggingWrapper(BaseWrapper):
    ...
    def __init__(
        ...
        Args:
            ...
            logger: Logger instance to use. If None, creates a logger named 'openkeyv.logging'.
            ...
            structured_logs: If True, logs the values as structured JSON.
    ...
    def _format_message(
        ...
        if self.structured_logs:
            ...
            return dump_to_json_bytes(obj=structured_data).decode()
